...
│   ├── core/
│   │   └── tensor.ring         # Math Engine (Hybrid FastPro/Ring)
│   ├── data/
│   │   ├── dataset.ring        # Base Dataset & DataLoader
│   │   └── datasplitter.ring   # Train/Test Split Utility
│   ├── layers/                 # Neural Network Layers
│   │   ├── layer.ring          # Base Class
│   │   ├── dense.ring          # Fully Connected
│   │   ├── activation.ring     # ReLU, Sigmoid
│   │   ├── tanh.ring           # Tanh Activation
│   │   ├── softmax.ring        # Softmax Layer
│   │   └── dropout.ring        # Dropout Layer
│   ├── loss/
│   │   ├── mse.ring            # Mean Squared Error
│   │   └── crossentropy.ring   # Cross Entropy Loss
│   ├── model/                  # Model Container
│   │   └── sequential.ring     # Model Container (Save/Load/Summary)
│   ├── optim/                  # Optimizers
│   │   ├── sgd.ring            # Stochastic Gradient Descent
│   │   └── adam.ring           # Adam Optimizer
│   └── utils/
│       └── serializer.ring     # High-Precision Saving Logic
├── examples/                   # Ready-to-run Demos
│   ├── xor_train.ring          # Binary Classification
│   ├── classify_demo.ring      # Multi-Class Demo
│   ├── mnist_train.ring        # MNIST Digit Recognition
│   └── Chess_End_Game/         # Full Real-world Project
